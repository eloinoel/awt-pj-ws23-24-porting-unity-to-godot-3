...
namespace KartGame.KartSystems
{
	...
	public partial class EngineAudio : Node
	{
		...
		public float RPM;
		[Export(hintString: "The minimum possible RPM of the engine.")]
		public float minRPM = 900;
		[Export(hintString: "The maximum possible RPM of the engine.")]
		public float maxRPM = 10000;
		[Export(hintString: "Increases randomness in engine audio.")]
		public float lumpyCamFactor = 0.05f;
		[Export(hintString: "Volume when at mininum RPM")]
		public float minVolume = 0.2f;
		[Export(hintString: "Volume when at maximum RPM")]
		public float maxVolume = 1.2f;
		[Export(hintString: "Smoothing of wave when a new stroke begins.")]
		public float strokeDamping = 0.1f;
		[Export(hintString: "Audio configuration for each engine stroke.")]
		public Stroke intake, compression, combustion, exhaust;
		[Export(hintString: "Map RPM to RPM^3")]
